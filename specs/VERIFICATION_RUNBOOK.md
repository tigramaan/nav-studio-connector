...
| V-007 Ubuntu package | PARTIAL | Ubuntu 22.04 VM release CLI built and ran. `.deb`/AppImage build is delegated to GitHub Actions because VM desktop build packages require sudo. |
