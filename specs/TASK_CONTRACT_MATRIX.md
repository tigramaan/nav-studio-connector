...
| Task | Public/internal contract |
|---|---|
| T-002 | `TrustDecision`, error taxonomy (internal) |
| T-003 | DNS-SD discovery contract v1 (public integration) |
| T-004 | platform trust operation plan (internal privileged boundary) |
...
| T-012 | public homepage, privacy/signing-policy disclosures and stable GitHub Pages URLs (public web contract) |
